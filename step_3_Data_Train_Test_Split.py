...
if test_set_size=='12'  :
    dataset["PRED_SET"] =0
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL"]==int(last_year_of_data),"PRED_SET" ]=1
    
elif test_set_size=='9'  :
#train test ayırmak için kullanılıyor
    dataset["PRED_SET"] =0
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'04'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'05'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'06'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'07'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'08'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'09'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'10'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'11'),"PRED_SET" ]=1
    dataset.loc[dataset["SEVKIYAT_OLUSTURMA_YIL_AY"]==int(last_year_of_data+'12'),"PRED_SET" ]=1
